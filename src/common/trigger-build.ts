...
export async function triggerBuild({ appSlug, tag, workflowId, commitMessage }: { appSlug: string, tag: string, workflowId?: string, commitMessage?: string }, {logger}: semantic.Context): Promise<void> {
